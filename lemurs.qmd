...
all_images <- list.files("images/") %>% 
  tibble(img = .) %>% 
  mutate(taxon = str_extract(img, pattern = "[^.]+")) %>% 
  mutate(img_html = glue::glue("<img src='https://raw.githubusercontent.com/nrennie/2022-table-contest/main/images/{img}' style='height:100px;'>"))
```
